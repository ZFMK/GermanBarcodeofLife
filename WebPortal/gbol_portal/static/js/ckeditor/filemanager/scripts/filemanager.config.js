...
// var fileRoot = '/home/wiebke/Git/gbol/gbol/static/images/';
var fileRoot = '/var/data/pyramidgbol/gbol/gbol/documents/media/news/';
...
var uploadRestrictions = ['jpg', 'JPG', 'jpeg', 'gif', 'png', 'txt', 'pdf', 'odp', 'ods', 'odt', 'rtf', 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx', 'ogv', 'mp4', 'webm', 'ogg', 'mp3', 'wav'];

// Allowed image extensions when type is 'image'
var imagesExt = ['jpg', 'JPG', 'jpeg', 'gif', 'png'];
