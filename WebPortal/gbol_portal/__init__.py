...
def main(global_config, **settings):
    ...
    config.scan()
    # config.scan('views')
    # config.scan('viewsSammler')
    # config.scan('viewsAdmin')
    # config.scan('viewsMitmachen')
    # config.scan('viewsTeam')
    # config.scan('viewsBarcoding')
    # config.scan('viewsErgebnisse')
    # config.scan('viewsNews')
    # config.scan('viewsGbol')
    # config.scan('viewsAjax')
